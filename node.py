...
class GroundingDinoSAMSegment_A100:
    ...
    def _apply_grow_mask(mask_tensor, expand, tapered_corners):
        """Apply Grow Mask (expand/shrink) to mask tensor. Ported from ComfyUI GrowMask."""
        if expand == 0:
            return mask_tensor
    ...
    def _apply_blockify_mask(mask_tensor, block_size, device_str="gpu"):
        """Apply Blockify Mask to mask tensor. Ported from KJNodes BlockifyMask."""
